  ...
  export namespace lobby {
    export class SectionTitle extends eui.Group {
      ...
      protected initComponents() {
        ...
        this._leftImg.source = 'd_lobby_title_left_png';
        this._leftImg.width = 227;
        this._leftImg.height = 62;
        this._rightImg = new eui.Image();
        this._rightImg.source = 'd_lobby_title_right_png';
        this._rightImg.width = 227;
        this._rightImg.height = 62;
