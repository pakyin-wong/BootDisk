...
(function (eui) {
    ...
    /**
     * The AnimTileLayout class arranges layout elements in columns and rows
     * of equally-sized cells.
     * The AnimTileLayout class uses a number of properties that control orientation,
     ...
     */
    /**
     * AnimTileLayout 类在单元格大小相等的列和行中排列布局元素。
     * AnimTileLayout 类使用许多属性来控制列和行的方向、计数、大小、间隙和两端对齐以及单元格内的元素对齐。
     *
     * @version Egret 2.4
     * @version eui 1.0
     * @platform Web,Native
     ...
     * @language zh_CN
     */
    var AnimTileLayout = (function (_super) {
        __extends(AnimTileLayout, _super);
        /**
         * Constructor.
         * @version Egret 2.4
         * @version eui 1.0
        ...
        Object.defineProperty(AnimTileLayout.prototype, "horizontalGap", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "verticalGap", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "columnCount", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "requestedColumnCount", {
            /**
             * Number of columns to be displayed.
             * <p>Set to 0 to allow the AnimTileLayout to determine
            ...
            /**
             * 要显示的列数。
             * <p>设置为 0 会允许 AnimTileLayout 自动确定列计数。</p>
        ...
        Object.defineProperty(AnimTileLayout.prototype, "rowCount", {
            /**
             * The row count.
             *
             * @version Egret 2.4
        ...
        Object.defineProperty(AnimTileLayout.prototype, "requestedRowCount", {
            /**
             * Number of rows to be displayed.
             * <p>Set to 0 to remove explicit override and allow the AnimTileLayout to determine
            ...
            /**
             * 要显示的行数。
             * <code>设置为 -1 会删除显式覆盖并允许 AnimTileLayout 自动确定行计数。</code>
        ...
        Object.defineProperty(AnimTileLayout.prototype, "columnWidth", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "rowHeight", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "paddingLeft", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "paddingRight", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "paddingTop", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "paddingBottom", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "horizontalAlign", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "verticalAlign", {
            /**
             * 指定如何在垂直方向上对齐单元格内的元素。
        ...
        Object.defineProperty(AnimTileLayout.prototype, "columnAlign", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "rowAlign", {
            /**
        ...
        Object.defineProperty(AnimTileLayout.prototype, "orientation", {
            /**
         ...
         * 标记目标容器的尺寸和显示列表失效
         */
        AnimTileLayout.prototype.invalidateTargetLayout = function () {
         ...
         * @platform Web,Native
         */
        AnimTileLayout.prototype.measure = function () {
            var target = this.$target;
            if (!target)
                return;
         ...
         * 计算行和列的尺寸及数量
         */
        AnimTileLayout.prototype.calculateRowAndColumn = function (explicitWidth, explicitHeight) {
            var target = this.$target;
            var horizontalGap = isNaN(this._horizontalGap) ? 0 : this._horizontalGap;
            var verticalGap = isNaN(this._verticalGap) ? 0 : this._verticalGap;
         ...
         * 更新最大子对象尺寸
         */
        AnimTileLayout.prototype.updateMaxElementSize = function () {
            if (!this.$target)
                return;
         ...
         * 更新虚拟布局的最大子对象尺寸
         */
        AnimTileLayout.prototype.doUpdateMaxElementSize = function (startIndex, endIndex) {
         ...
         * @platform Web,Native
         */
        AnimTileLayout.prototype.clearVirtualLayoutCache = function () {
         ...
         * @platform Web,Native
         */
        AnimTileLayout.prototype.scrollPositionChanged = function () {
            if (this.$useVirtualLayout) {
         ...
         */
        AnimTileLayout.prototype.getIndexInView = function () {
         ...
         * @platform Web,Native
         */
        AnimTileLayout.prototype.updateDisplayList = function (width, height) {
         ...
         * 为单个元素布局
         */
        AnimTileLayout.prototype.sizeAndPositionElement = function (element, cellX, cellY, cellWidth, cellHeight) {
         ...
         * 为两端对齐调整间隔或格子尺寸
         */
        AnimTileLayout.prototype.adjustForJustify = function (width, height) {
            var paddingL = this._paddingLeft;
            var paddingR = this._paddingRight;
            var paddingT = this._paddingTop;
            var paddingB = this._paddingBottom;
        ...
        return AnimTileLayout;
    }(eui.LayoutBase));
    eui.AnimTileLayout = AnimTileLayout;
    __reflect(AnimTileLayout.prototype, "eui.AnimTileLayout");
})(eui || (eui = {}));
