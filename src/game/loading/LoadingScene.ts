  ...
  export namespace loading {
    export class Scene extends core.BaseScene {
      ...
      private async loadGeneralRes() {
        RES.createGroup('firstRun', [core.res.Lobby, core.res.Baccarat, core.res.DragonTiger, core.res.Roulette, core.res.Dice, core.res.Common, core.res.Nav, core.res.LuckyWheel, 'temp', 'test', core.res.Blockchain, core.res.BlockchainBaccarat, core.res.BlockchainDragonTiger]);
