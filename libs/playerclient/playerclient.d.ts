...
declare class PlayerClient {
    ...
    getGameStatusBA(hostID: string, option: number, index: number, to: number, callback?: Function): void;
    getGameStatusDT(hostID: string, option: number, index: number, to: number, callback?: Function): void;
