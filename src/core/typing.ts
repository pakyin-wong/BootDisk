...
namespace we {
  export namespace core {
    export interface ISocket {
      getGameStatusBA(hostID: string, option: number, from:number, to: number, callback?: Function): void;
      getGameStatusDT(hostID: string, option: number, from:number, to: number, callback?: Function): void;      
