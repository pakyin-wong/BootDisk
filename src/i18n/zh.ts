namespace we {
  export namespace i18n {
    export const zh = {
      ...
      betfield_baccarat_super_six_player: '閒',
      betfield_baccarat_super_six_banker: '庄',
      betfield_baccarat_super_six_player_pair: '閒對',
      betfield_baccarat_super_six_tie: '和',
      betfield_baccarat_super_six: '超級六',
      betfield_baccarat_super_six_banker_pair: '庄對',
      ...
      overlaypanel_bethistory_recordtab_gameround: '遊戲編號',
      ...
      overlaypanel_bethistory_record_gameid: '遊戲編號',
      ...
      dragontiger: {
        ...
        askDragon: '龍問路',
        askTiger: '虎問路',
        DragonTigerTieRatio: '龍和虎比例',
        DragonTigerTieRatio100: '龍和虎比例(100局)',
        DragonTigerTieRatioshoe: '龍和虎比例(本靴)',
        TieRatio: '和比例',
        DealerRatio: '荷官開龍虎比例',
        round: '局',
        rounds: '局',
      ...
      baccarat: {
        tooltip: {
          ...
          mobileEncryptedKeyHelp: '提前公佈卡牌加密文： \n每靴洗牌後，系統對每張「卡牌序號」進行區塊鏈技術加密並提前公開展示，一旦生成即不能更改。 ',
          decryptedKeyHelp: '卡牌加密文： \n開牌後，系統會顯示根據「卡牌序號」而生成的「卡牌加密文」，並自動與「提\n前公佈卡牌加密文」進行驗証。',
          mobileDecryptedKeyHelp: '卡牌加密文： \n開牌後，系統會顯示根據「卡牌序號」而生成的「卡牌加密文」，並自動與「提前公佈卡牌加密文」進行驗證。 ',
          ssnHelp: '卡牌序號：\n(i)首兩位字元為卡牌的「點數」\nA為1點；J為11點；Q為12點；K為13點；其它牌(2、3、4、5、6、7、8、9)\n依牌面數字面值 \n \n(ii)第三位字元為卡牌的「花色」：\nH為紅心(Heart)\nD為方塊(Diamond)\nS為黑桃(Spade)\nC為梅花(Clubs)\n \n(iii) 其後會加入34個「隨機字符」，保證序號的唯一性 ；每次「隨機字符」均會重新生成，即「本局」梅花J的「隨機字符」與「上局」梅花J的隨機字符不同。 \n \n(iv) 例子：梅花J \n「11」代表點數－J \n「C」代表花色－梅花 \n「fhjkssadfhkh32iuhksdhfkjasJCO123ES」為隨機字符',
          mobileSsnHelp: '卡牌序號：\n(i)首兩位字元為卡牌的「點數」\nA為1點；J為11點；Q為12點；K為13點；其它牌(2、3、4、5、6、7、8、9)\n依牌面數字面值 \n \n(ii)第三位字元為卡牌的「花色」：\nH為紅心(Heart)\nD為方塊(Diamond)\nS為黑桃(Spade)\nC為梅花(Clubs)\n \n(iii) 其後會加入34個「隨機字符」，保證序號的唯一性 ；每次「隨機字符」均會重新生成，即「本局」梅花J的「隨機字符」與「上局」梅花J的隨機字符不同。 \n \n(iv) 例子：梅花J \n「11」代表點數－J \n「C」代表花色－梅花 \n「fhjkssadfhkh32iuhksdhfkjasJCO123ES」為隨機字符',
        },
        statisticChart: {
      ...
      error: {
        ...
        error_3021: '儲存自定好路失敗',
        error_3022: '移除自定好路失敗',
        error_3030: '獲取自選投注組合失敗',
        error_3031: '儲存自選投注組合失敗',
        error_3032: '移除自選投注組合失敗',
      ...
      lo_fun_betlayer_info: '中獎說明',
      lo_fun_betlayer_info_fun:
        '大小單雙：\n從萬位、千位、百位、十位、個位任意位置上至少選擇 1 個以上形態，所選號碼的位置、形態與開獎號碼的位置、形態相同，即為中獎\n前三| 中三| 後三：\n所選的號碼特殊屬性和開獎號碼前三的屬性一致，即為中獎 1、豹子號指的是三位數字全部相同 2、順子號指的是三位數字呈現連號狀態（ 09 也屬於連號）（ 順序不限）（ 出現兩個相同號即為對子， 不算半順）（ 出現三個號碼呈現連號狀態為順子號， 不算半順號）3、對子號指的是三位數字中有任兩碼為相同號（ 出現三個相同號為豹子號， 不算對子號）4、半順號指的是三位數字中，有兩個號碼呈現連號狀態（ 09 也屬於連號）（ 順序不限）5、雜六號指的是三位數字中， 狀態非豹子號、 順子號、 對子號、 半順號，即為雜六\n總和：\n從總和大、小、單、雙中任意選擇 1 個號碼形態組成一注，只要所選形態與開獎號碼的 5 位數號碼總和（大於等於 23：總和大、小於等於 22：總和小、單數：總和單、雙數：總和雙）形態相同，即為中獎',
      lo_fun_betlayer_info_num: '數字玩法：\n從萬位、千位、百位、十位、個位任意位置上至少選擇 1 個或以上的號碼，所選號碼與相同位置上的開獎號碼一致，即為中獎',
      lo_fun_betlayer_info_dt:
        '龍虎和：\n從龍、虎、和中任意選擇 1 個號碼形態組成一注，只要開獎號碼的萬位大於個位，則為龍；萬位小於個位，則為虎；相同號碼則為和，若下注龍或虎，開獎結果為和時視為未中獎，且不返回本金',
      lo_fun_betlayer_info_five1: '全五中一：\n從 0 - 9 中選擇 1 個號碼，每注由 1 個號碼組成，開獎號碼的萬位、千位、百位、十位、個位中同時包含所選的 1 個號碼，即為中獎',
      ...
      lo_trad: {
        ...
        betDescription: {
          ...
          SizeParity: {
            LastSizeParity: '開獎號碼的十位、個位的開獎形態與投注一致即中獎',
            FrontSizeParity: '開獎號碼的萬位、千位的開獎形態與投注一致即中獎',
            TenThousandSizeParity: '開獎號碼萬位的開獎形態與投注一致即中獎',
            ThousandSizeParity: '開獎號碼千位的開獎形態與投注一致即中獎',
            HundredSizeParity: '開獎號碼百位的開獎形態與投注一致即中獎',
            TenSizeParity: '開獎號碼十位的開獎形態與投注一致即中獎',
            SingleSizeParity: '開獎號碼個位的開獎形態與投注一致即中獎',
          },
          Interest: {
