namespace we {
  export namespace test {
    export class TestGameRulePanelPage extends core.BasePage {
      private progressbar: eui.ProgressBar;
      private b = 0;
      private test : we.ui.GameRulePanel;
      public onEnter() {
      ...
      protected mount() {
        ...
        const a = new we.ui.GameRulePanel();
        this.addChild(a);
      ...
      protected onTouch(e){
        ...
        this.test.currentState = temp;
        this.test.invalidateState();
