namespace we {
  export namespace lo {
    export class LoRoadmapControl {
      ...
      protected colorRoad: ro.ROColorBigRoad;
      protected sizeRoad: ro.ROSizeBigRoad;
      protected oddRoad: ro.ROOddBigRoad;
      protected leftPanel: ro.IHotColdPanel;
      protected rightPanel: ro.RoRightPanel;
