  ...
  export namespace core {
    export class Monitor {
      ...
      public start(stage: egret.Stage) {
        ...
        this.testCollapser1.$x = 2000;
        this.testCollapser1.$y = 100;
        ...
        this.testCollapser3.$x = 400;
        this.testCollapser3.$y = 100;
