...
namespace we {
  export namespace overlay {
    export class SSCTraditionalMobileChaseBetConfirmPanel extends SSCTraditionalMobileBetConfirmPanel {
    ...
    //   protected _lblChaseRoundCount: ui.RunTimeLabel;
      ...
      public updateText() {
        super.updateText();
        this._lblTitleRoundNumber.renderText = () => `${i18n.t('lo_trad.confirm_panel.startroundtitle')}`;
