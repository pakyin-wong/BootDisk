...
namespace we {
  export namespace lo {
    export class MobileBottomBeadRoadPanel extends core.BaseGamePanel {
      public beadRoad: di.DiBeadRoad;

      protected beadRoadConfig: di.RoadMapConfig;
      ...
      protected initRoadMap() {
        switch (env.orientation) {
          case 'portrait':
            ...
            this.beadRoad = new di.DiBeadRoad(1242, 1, 9, 120, 1, options); // in game
            // this.beadRoad.x = 29;
            // this.beadRoad.y = 16;
          ...
          case 'landscape':
            ...
            this.beadRoad = new di.DiBeadRoad(845, 1, 8, 70, 1, options); // in game
            // this.beadRoad.x = 29;
            // this.beadRoad.y = 16;
            this.beadRoad.scaleX = 689 / 689;
            this.beadRoad.scaleY = 689 / 689;
