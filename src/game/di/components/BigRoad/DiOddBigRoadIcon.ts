namespace we {
  export namespace di {
    export class DiOddBigRoadIcon extends ba.BARoadIconBase {
      ...
      public changeLang() {
        if (this.value) {
          if (this.value.v !== undefined) {
            if (this.value.v === 0) {
              // green
              this.iconText.text = i18n.t('dice.tripleShort');
            } else if (this.value.v === 2) {
              // red for even
              this.iconText.text = i18n.t('dice.evenShort');
            } else {
              // blue for odd
              this.iconText.text = i18n.t('dice.oddShort');
            }
          }
        }
      }
      ...
      protected initGraphics() {
        ...
        const colors = [0x3e60f8, 0xee2e2e, 0x10b04b, 0xff0000, 0x0000ff, 0x00ff00];
