...
namespace we {
  export namespace dil {
    export class MobileBottomRoadmapPanel extends core.BaseGamePanel {
      ...
      public sumRoad: we.di.DiSumBigRoad;
      public sizeRoad: we.di.DiSizeBigRoad;
      public oddRoad: we.di.DiOddBigRoad;

      protected sumBigRoadConfig: we.di.RoadMapConfig;
      protected sizeBigRoadConfig: we.di.RoadMapConfig;
      protected oddBigRoadConfig: we.di.RoadMapConfig;
      ...
      protected initRoadMap() {
        switch (env.orientation) {
          case 'portrait':
            this.sumRoad = new we.di.DiSumBigRoad(18, 68, 1, false);
            this.sumBigRoadConfig.parent.addChild(this.sumRoad);

            this.sizeRoad = new we.di.DiSizeBigRoad(18, 68, 1, false);
            this.sizeBigRoadConfig.parent.addChild(this.sizeRoad);

            this.oddRoad = new we.di.DiOddBigRoad(18, 68, 1, false);
            this.oddBigRoadConfig.parent.addChild(this.oddRoad);
            break;
          case 'landscape':
            this.sumRoad = new we.di.DiSumBigRoad(18, 45, 1, false);
            this.sumBigRoadConfig.parent.addChild(this.sumRoad);

            this.sizeRoad = new we.di.DiSizeBigRoad(18, 45, 1, false);
            this.sizeBigRoadConfig.parent.addChild(this.sizeRoad);

            this.oddRoad = new we.di.DiOddBigRoad(18, 45, 1, false);
            this.oddBigRoadConfig.parent.addChild(this.oddRoad);
            break;
        }
      }
