namespace we {
  export namespace i18n {
    export const cn = {
      ...
      gametype_BAM: '共咪百家乐',
      gametype_BAB: '区块链百家乐',
      gametype_BASB: '区块链极速百家乐',
      gametype_BAMB: '区块链共咪百家乐',
      gametype_DI: '骰宝',
      gametype_DIL: '财神骰宝',
      gametype_MJ: '麻将',
      gametype_RO: '轮盘',
      ...
      table_offline_text: '本台游戏暂停，现在返回游戏大堂',
      ...
      dragontiger: {
        ...
        askDragon: '龙问路',
        askTiger: '虎问路',
        DragonTigerTieRatio: '龙和虎比例',
        DragonTigerTieRatio100: '龙和虎比例(100局)',
        DragonTigerTieRatioshoe: '龙和虎比例(本靴)',
        TieRatio: '和比例',
        DealerRatio: '荷官开龙虎比例',
        round: '局',
        rounds: '局',
      ...
      baccarat: {
        tooltip: {
          ...
          ssnHelp: '卡牌序号：\n(i)首两位字元为卡牌的「点数」\nA为1点；J为11点；Q为12点；K为13点；其它牌(2、3、 4、5、6、7、8、9)\n依牌面数字面值\n \n(ii)第三位字元为卡牌的「花色」：\nH为红心(Heart)\nD为方块(Diamond)\nS为黑桃(Spade)\nC为梅花(Clubs)\n \n(iii)其后会加入34个“随机字符”，保证序号的唯一性；每次“随机字符”均会重新生成，即“本局”梅花J的“随机字符”与“上局”梅花J的 随机字符不同。 \n \n(iv)例子：梅花J \n「11」代表点数－J \n「C」代表花色－梅花 \n「fhjkssadfhkh32iuhksdhfkjasJCO123ES」为随机字元',
          mobileSsnHelp: '卡牌序号：\n(i)首两位字元为卡牌的「点数」\nA为1点；J为11点；Q为12点；K为13点；其它牌(2、3、 4、5、6、7、8、9)\n依牌面数字面值\n \n(ii)第三位字元为卡牌的「花色」：\nH为红心(Heart)\nD为方块(Diamond)\nS为黑桃(Spade)\nC为梅花(Clubs)\n \n(iii)其后会加入34个“随机字符”，保证序号的唯一性；每次“随机字符”均会重新生成，即“本局”梅花J的“随机字符”与“上局”梅花J的 随机字符不同。 \n \n(iv)例子：梅花J \n「11」代表点数－J \n「C」代表花色－梅花 \n「fhjkssadfhkh32iuhksdhfkjasJCO123ES」为随机字元',
        },
        statisticChart: {
        ...
        fullShoe: '完整牌靴',
        mechanismHelp: '机制说明',
        mechanismHelp1: '游戏以电子模式发牌，每张牌均拥有一个「卡牌序号」',
        mechanismHelp2: '每张卡牌拥有独立的「卡牌序号」，并以SHA-256技术加密生成「卡牌加密文」。',
