namespace we {
  export namespace core {
    export const Event = {
      ...
      SWITCH_AUTO_CONFIRM_BET: 'SWITCH_AUTO_CONFIRM_BET',
      ...
      LIVE_TABLE_INDEX_UPDATE: 'LIVE_TABLE_INDEX_UPDATE',
      ...
      PLAYER_LOTTERY_STAT: 'PLAYER_LOTTERY_STAT',
    };
    ...
    export const MQTT = {
      ...
      GAME_STATISTIC_UPDATE_BA: 'GAME_STATISTIC_UPDATE_BA',
      GAME_STATISTIC_UPDATE_DT: 'GAME_STATISTIC_UPDATE_DT',
      BALANCE_UPDATE: 'BALANCE_UPDATE',
      PLAYER_BET_INFO_UPDATE: 'PLAYER_BET_INFO_UPDATE',
      PLAYER_BET_RESULT: 'PLAYER_BET_RESULT',
      ERROR: 'ERROR',
