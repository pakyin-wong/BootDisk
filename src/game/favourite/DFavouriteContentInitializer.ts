...
namespace we {
  export namespace favourite {
    export class DFavouriteContentInitializer implements IContentInitializer {
      ...
      public initContent(root: GameTableList) {
        ...
        this.roomLayout.paddingTop = 350 + offsetForTableList + this.gapSize + 100;
        ...
        root.tabs = new we.live.SegmentedControl(root.tabItems);
        tabBarGroup.addChild(root.tabs);
        // tabBarGroup.addChild(new live.LiveDisplayModeSwitch());
        ...
        this._stickyHeader.y = offsetForTableList + this.gapSize;
