namespace we {
  export namespace i18n {
    export const en = {
      ...
      gametype_BAS: 'Speed Baccarat',
      gametype_BAI: 'BAI',
      gametype_BAM: 'Squeeze Baccarat ',
      gametype_BAB: 'BAB',
      gametype_BAMB: 'Blockchain Squeeze Baccarat',
      gametype_DI: 'Sic-bo',
      gametype_DIL: 'GOF Sic-bo',
      gametype_MJ: 'MJ',
      gametype_RO: 'Roulette',
      gametype_ROL: 'GOF Roulette',
      gametype_DT: 'Dragon Tiger',
      gametype_DTB: 'DTB',
      gametype_LW: 'Luckywheel',
      gametype_LO: 'Lottery',
      gametype_RC: 'RC',
      ...
      overlaypanel_bethistory_tab_live: 'Live Casino',
      ...
      baccarat: {
        tooltip: {
          ...
          encryptedKeyHelp:'Published Serial Number: \nAfter each shoe has shuffled, every card has a "Serial number" which is generated by "Private key" through blockchain encryption technology and will be published in advance. It cannot be changed once it is generated. ',
          mobileEncryptedKeyHelp:'Published Serial Number: \nAfter each shoe has shuffled, every card has a "Serial number" which is generated by "Private key" through blockchain encryption technology and will be published in advance. It cannot be changed once it is generated. ',
          decryptedKeyHelp:'Card encryption text: \nAfter dealing, the "Verified Serial Number" is  generated by "Private Key" and verify with "Published Serial Number" automatically.',
          ...
          ssnHelp: '"Private Key: \n(i) First 2 digits represent the "Card Point" \n"Aces" counts one; ‘Jacks’ counts eleven; ‘Queens’ counts twelve; ‘Kings’ counts \nthirteen; the other cards (2、3、4、5、6、7、8、9) count their corresponding point\nvalue.\n \n(ii) Third alphabet represents the "Card Suit"\nH represents Heart\nD represents Diamond\nS represents Spade\nC represents Clubs\n \n(iii) After that, 34 random characters will be added to ensure the fairness and\nuniqueness of the serial number. The serial number will be regenerared after each\ncard shuffling. For example, the serial number of "Club J" was different from that of\nprevious game.\n \n(iv) Such as,  "Club J"\n"11" represents J\n"C" represents Club\n"fhjkssadfhkh32iuhksdhfkjasJCO123ES" are random characters"',
          mobileSsnHelp: '"Private Key: \n(i) First 2 digits represent the "Card Point" \n"Aces" counts one; ‘Jacks’ counts eleven; ‘Queens’ counts twelve; ‘Kings’ counts thirteen; the other cards (2、3、4、5、6、7、8、9) count their corresponding point value.\n \n(ii) Third alphabet represents the "Card Suit"\nH represents Heart\nD represents Diamond\nS represents Spade\nC represents Clubs\n \n(iii) After that, 34 random characters will be added to ensure the fairness and uniqueness of the serial number. The serial number will be regenerared after each card shuffling. For example, the serial number of "Club J" was different from that of previous game.\n \n(iv) Such as,  "Club J"\n"11" represents J\n"C" represents Club\n"fhjkssadfhkh32iuhksdhfkjasJCO123ES" are random characters"',
        },
        statisticChart: {
          bankerPlayerTie: 'BPT ratio (100 Rounds)',
          bankerPlayerTiePair: 'Pair ratio (100 Rounds)',
          shoeBankerPlayerTie: 'BPT ratio (Shoe)',
          shoeBankerPlayerTiePair: 'Pair ratio (Shoe)',
        },
        playerPair: 'Player Pair',
        bankerPair: 'Banker Pair',
        playerPairShort: 'P.P',
        ...
        askBanker: 'Ask B',
        askPlayer: 'Ask P',
        statType100: '100 Rounds',
        statTypeShoe: 'Shoe',
        BankerPlayerRatio: 'BPT ratio',
        ...
        deckDesc: '"All Cards" consists of 8 decks of playing cards, which have 416 cards in total. Before the start of the first round, the system will randomly insert a red card in "All Cards". When the card is dealt to the red card, it means that the shoe will be changed after that round of game ends. After the cards have shuffled, the "Private Key" and "Verified Serial Number" will be regenerated to ensure the authenticity of the game.',
        copy: 'Copy',
      ...
      error: {
        ...
        error_2000: 'System under maintenance',
        error_2001: 'Player account suspended',
        error_2002: 'Network not stable/connecting',
        error_2003: 'Network disconnected',

        error_3000: 'Get table list error',
        error_3001: 'Table not available',
        error_3010: 'Get player settings error',
        error_3011: 'Save player settings error',
        error_3012: 'Get player balance error',
        error_3020: 'Get custom roadmap error',
        error_3021: 'Save custom roadmap  error',
        error_3022: 'Remove custom roadmap error',
        error_3030: 'Get player bet template error',
        error_3031: 'Save player bet template error',
        error_3032: 'Remove player bet template error',
