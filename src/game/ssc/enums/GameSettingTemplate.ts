    ...
    export const template = {
      template: {
        ...
        type: {
          ...
          Five30: {
            name: 'Five30',
            input: [InputComponentDefinition.ballRange('Double', 0, 9, 2), InputComponentDefinition.ballRange('Single', 0, 9, 1)],
          ...
          SumGroup345: {
            name: 'SumGroup345',
            input: [InputComponentDefinition.ballRange('', 1, 26, 1, InputDataType.SEPARATOR)],
          ...
          DT12: {
            name: 'OptionalFree12',
            input: [InputComponentDefinition.ballData('', ['DRAGON', 'TIGER', 'TIE'], 1, InputDataType.ARRAY)],
          ...
          OptionalInput12345: {
            ...
            input: [InputComponentDefinition.textArea('', 5)],
