namespace we {
  export namespace di {
    export class DiSizeBigRoadIcon extends DiBigRoadIconBase {
        ...
        if (this.value) {
          if (this.value.v !== undefined) {
            if (this.value.v === 0) {
              ...
              // blue for small
              this._iconText.text = i18n.t('dice.smallShort');
            } else {
              // red for big
              this._iconText.text = i18n.t('dice.bigShort');
            }
          }
        }
      }
      ...
      public updateDisplay() {
        ...
        if (value.v != null) {
          ...
          // this._iconShape.graphics.drawRoundRect(lineWidth, lineWidth, iconSize - lineWidth * 2, iconSize - lineWidth * 2, 16, 16);
