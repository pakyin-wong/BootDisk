namespace we {
  export namespace dil {
    export class LeftPanel extends core.BaseGamePanel {
      ...
      public sizeBigRoad: we.di.DiSizeBigRoad;
      public oddBigRoad: we.di.DiOddBigRoad;
      public sumBigRoad: we.di.DiSumBigRoad;
      ...
      protected init() {
        ...
        this.beadRoad = new we.di.DiBeadRoad(2, 8, 48, 1, 19, 24, 6, [0xe4493a, 0x6dd400, 0x2da1fe, 0x184077, 1]); // in game
        this.beadRoad.x = 29;
        this.beadRoad.y = 16;
        ...
        this.sizeBigRoad = new we.di.DiSizeBigRoad(17, 34, 1, true);
        ...
        this.oddBigRoad = new we.di.DiOddBigRoad(17, 34, 1, true);
        ...
        this.sumBigRoad = new we.di.DiSumBigRoad(17, 34, 1, true);
