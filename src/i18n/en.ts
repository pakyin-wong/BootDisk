namespace we {
  export namespace i18n {
    export const en = {
      ...
      overlaypanel_bethistory_tab_all: 'Game Overview',
      overlaypanel_bethistory_tab_live: 'Live Game',
      overlaypanel_bethistory_tab_lottery: 'Lottery',
      overlaypanel_bethistory_tab_egame: 'eGame',
      overlaypanel_bethistory_date: 'Date',
      ...
      overlaypanel_bethistory_searchrecord: 'Search',
      ...
      overlaypanel_bethistory_recordtab_win: 'Payout',
      ...
      expiredmessage_text: 'You have not bet for 3 rounds, and will be back to lobby after 2 rounds.',
       ...
       table_offline_text: 'The game is suspended,  back to lobby now.',
      ...
      goodroad: {
        ...
        r1: 'Long Banker',
        r2: 'Long Player',
        r3: 'Long Banker Sticks on Long Player',
      ...
      baccarat: {
        tooltip: {
          ...
          cardIDHelp: 'Order Number:： \nEvey cards had an order number that determines the card dealing sequence.',
          encryptedKeyHelp: "Published Serial Number: \nAfter each shoe has shuffled, every card has a 'Serial number' which is generated by 'Private key' through blockchain encryption technology and will be published in advance. \nIt cannot be changed once it is generated.",
          ...
          mobileDecryptedKeyHelp: "Card encryption text: \nAfter dealing, the 'Verified Serial Number' is  generated by 'Private Key' and verify with 'Published Serial Number' automatically.",
