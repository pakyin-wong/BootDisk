  ...
  export namespace bamb {
    export class CardHolder extends bab.CardHolder {
      ...
      public setDefaultStates() {
        this._playerCard1.animation.gotoAndPlayByTime('vertical_out_back', 1);
        this._playerCard2.animation.gotoAndPlayByTime('vertical_out_back', 1);
        this._playerCard3.animation.gotoAndPlayByTime('vertical_out_back', 1);
        this._bankerCard1.animation.gotoAndPlayByTime('vertical_out_back', 1);
        this._bankerCard2.animation.gotoAndPlayByTime('vertical_out_back', 1);
        this._bankerCard3.animation.gotoAndPlayByTime('vertical_out_back', 1);
        if (this._smallCard1Group && this._smallCard2Group) {
          this._smallCard1.animation.gotoAndPlayByTime('vertical_out_back', 1);
          this._smallCard2.animation.gotoAndPlayByTime('vertical_out_back', 1);
        }
      }
      ...
      protected setStatePeek(isInit: boolean) {
        ...
        if (utils.bam.isPlayerFlipAllowed(this._chipLayer)) {
          ...
          if (isInit) {
            ...
            this._playerCard1.animation.play('sq_vertical_select_loop');
          } else {
          ...
          if (isInit) {
            ...
            this._playerCard1.animation.gotoAndPlayByTime('sq_vertical_dark_loop_back', 0);
            this._playerCard2.animation.gotoAndPlayByTime('sq_vertical_dark_loop_back', 0);
          } else {
        ...
        if (utils.bam.isBankerFlipAllowed(this._chipLayer)) {
          ...
          if (isInit) {
            this._bankerCard1.animation.gotoAndPlayByTime('sq_vertical_dark_loop_back', 0);
            this._bankerCard2.animation.gotoAndPlayByTime('sq_vertical_dark_loop_back', 0);
          } else {
        ...
        if (utils.bam.isBankerFlipAllowed(this._chipLayer) && !utils.bam.isPlayerFlipAllowed(this._chipLayer)) {
          ...
          this._flipCardHolder.setCenterCardVisible(true, 'vertical');
          if (isInit) {
            this._bankerCard1.animation.play('sq_vertical_select_loop');
          } else {
      ...
      protected setStatePeekPlayer(isInit: boolean) {
        ...
        if (utils.bam.isPlayerFlipAllowed(this._chipLayer)) {
          ...
          this._playerCard3Group.touchEnabled = false;
          this._playerCard3.animation.gotoAndPlayByTime('sq_horizontal_dark_loop_back', 0);
        }
      ...
      protected setStatePeekBanker(isInit: boolean) {
        ...
        if (utils.bam.isBankerFlipAllowed(this._chipLayer)) {
          ...
          this._flipCardHolder.setCenterCardsTouchEnabled(false, 'horizontal');
          this._bankerCard3Group.touchEnabled = false;
          this._bankerCard3.animation.gotoAndPlayByTime('sq_horizontal_dark_loop_back', 0);
        }
      ...
      protected showVerticalLoopBack(display: dragonBones.EgretArmatureDisplay, time: number) {
        ...
        display.animation.gotoAndPlayByProgress('vertical_in', 1);
        // display.armature.invalidUpdate();
      }
      ...
      protected showHorizontalLoopBack(display: dragonBones.EgretArmatureDisplay, time: number) {
        ...
        display.animation.gotoAndPlayByProgress('sq_horizontal_flip', 1);
        // display.armature.invalidUpdate();
      }

      protected checkCardAllOpened() {
        if (this._gameData.state === core.GameState.PEEK) {
          if (this._playerCard1.name === 'flipped' && this._playerCard2.name === 'flipped') {
            this._openAllPlayerGroup.visible = false;
          }
          if (this._bankerCard1.name === 'flipped' && this._bankerCard2.name === 'flipped') {
            this._openAllBankerGroup.visible = false;
          }
        }
      ...
      protected openAll(side: string) {
        const card1 = side === 'player' ? this._playerCard1 : this._bankerCard1;
        const card2 = side === 'player' ? this._playerCard2 : this._bankerCard2;
        const card3 = side === 'player' ? this._playerCard3 : this._bankerCard3;
        const state = side === 'player' ? core.GameState.PEEK_PLAYER : core.GameState.PEEK_BANKER;
        const group = side === 'player' ? this._openAllPlayerGroup : this._openAllBankerGroup;
        ...
        return () => {
          ...
          if (this._currentFocusCard) {
            if (this._currentFocusCard.name === 'flipped') {
              this._currentFocusCard.animation.gotoAndPlayByTime(`sq_${orientation}_loop_front`, 0);
            } else {
      ...
      protected showCenterCard(orientation: string, dataName: string) {
        ...
        this._flipCardHolder.setCenterFlipCard(this._gameData[dataName], orientation, dataName);
