      ...
      template: {
        ...
        type: {
          ...
          OptionalFree12: {
            ...
            dataSelect: 2, // 5 data choose 2, if not set, use input.length
          ...
          DT12: {
            name: 'OptionalFree12',
            input: [
              InputComponentDefinition.ballData('',['DRAGON','TIGER','TIE'],1,InputDataType.SEPARATOR)
            ],
            pattern:'12DT_$1'
          },
          Front2SizeParity: {
            ...
            input: [
              InputComponentDefinition.ballData('TenThousand',['BIG','SMALL','EVEN','ODD'],1,InputDataType.SEPARATOR),
          ...
          OptionalInput12: {
            ...
            input: [
              InputComponentDefinition.textArea('',2),
